...
function ScrollSelector(width, height, values, callback) {
	...
	for(var i = 0; i < values.length; i++) {
		...
		if(i === 0) tab.div.style.borderTop = height/4+"px solid lime";
		if(i === values.length-1) tab.div.style.borderBottom = height/4+"px solid lime";
	}
